...
export default function WhatsAppWidget() {
  return (
    <>
      ...
      <a href="https://wa.me/918791147964" target="_blank" rel="noopener noreferrer" className="whatsapp-widget" aria-label="Chat on WhatsApp">
        ...
        <div className="whatsapp-tooltip">Chat with Recruiter</div>
      </a>
    </>
  );
}
